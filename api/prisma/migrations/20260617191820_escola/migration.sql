...
CREATE TABLE `Atividade` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `numeroAtividade` INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Atividade` ADD CONSTRAINT `Atividade_professorId_fkey` FOREIGN KEY (`professorId`) REFERENCES `Professor`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
